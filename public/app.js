...
function applyLocale() {
  ...
  document.querySelector('#primary-label').textContent = text.primary;
  document.querySelector('#secondary-label').textContent = text.secondary;
  document.querySelector('#secondary-base-label').textContent = text.base;
  document.querySelector('#secondary-result-label').textContent = text.result;
  ...
  document.querySelector('#base-number').previousElementSibling.textContent = text.base;
  document.querySelector('#result-number').previousElementSibling.textContent = text.result;
...
function renderResult(payload) {
  ...
  const meaningIndex = payload.locale === 'en' ? 0 : 1;
  emptyState.hidden = true;
  resultContent.hidden = false;
  resultSubtitle.textContent = `${result.format} / ${result.inputLength} ${translations[payload.locale]?.format || 'digits'}`;
  document.querySelector('#primary-number').textContent = primary.base.number;
  document.querySelector('#base-number').textContent = primary.base.number;
  document.querySelector('#base-meaning').textContent = primary.base.meaning[meaningIndex];
  document.querySelector('#result-number').textContent = primary.result.number;
  document.querySelector('#result-meaning').textContent = primary.result.meaning[meaningIndex];
  document.querySelector('#secondary-number').textContent = secondary.base.number;
  document.querySelector('#secondary-base-number').textContent = secondary.base.number;
  document.querySelector('#secondary-base-meaning').textContent = secondary.base.meaning[meaningIndex];
  document.querySelector('#secondary-result-number').textContent = secondary.result.number;
  document.querySelector('#secondary-result-meaning').textContent = secondary.result.meaning[meaningIndex];
}
